        ...
        Scaffold(
            ...
            NavHost(
                ...
                composable(Route.CUSTOMERS.name) {
                    CustomersScreen(viewModel, onNavigateToAddCustomer = { navController.navigate(Route.ADD_CUSTOMER.name) })
                }
                ...
                composable(Route.ADD_FABRIC.name) {
                    AddFabricScreen(viewModel, onNavigateBack = { navController.popBackStack() })
                }
