...
@Composable
fun FabricsScreen(viewModel: SublimationViewModel, onNavigateToAddFabric: () -> Unit, onNavigateToEditFabric: (Long) -> Unit) {
            ...
            if (fabrics.isEmpty()) {
                ...
                LazyColumn(modifier = Modifier.fillMaxSize()) {
                    items(fabrics) { fabric ->
                        FabricItem(fabric = fabric, onClick = { onNavigateToEditFabric(fabric.id) })
                    }
                }
            }
        }
